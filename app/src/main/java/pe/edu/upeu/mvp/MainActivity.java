...
public class MainActivity extends AppCompatActivity implements Main.Vista {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsuma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                presentador.calcularSuma(edt1.getText().toString(),edtsuma.getText().toString());
            }
        });
        btnresta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                presentador.calcularResta(edt1.getText().toString(),edtsuma.getText().toString());
            }
        });
    }
    ...
    public void mostrarSuma(String s) {
        Toast.makeText(getApplicationContext(),"Suma:"+s,Toast.LENGTH_LONG).show();;
